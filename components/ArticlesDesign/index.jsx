...
// Css File
import "./ArticlesDesign.css";

function ArticlesDesign(props) {
  const {
    component1261,
    component1271,
    component1251,
  ...
  return (
    <div className="container-center-horizontal">
      <div className="articles-design screen">
        <div className="overlap-group4-13">
          <Particle />
          <div className="rectangle-177-20"></div>
          <img className="component-126-1" src={component1261} />
          <img className="component-127-1" src={component1271} />
          <div className="article-title-here montserrat-semi-bold-white-55px">
            Article Title Here
          </div>
          <p className="lorem-ipsum-dolor-si-34 montserrat-normal-white-16px">
          ...
          <img className="component-125-1" src={component1251} />
          <div className="group-780-1">
            <ArticleSidebar />
            <ArticleSidebar className={group5471Props.className} />
            <ArticleSidebar className={group5472Props.className} />
          </div>
          <div className="you-might-like">You Might Like</div>
          <div className="rectangle-198-3"></div>
          <Navbar2 />
        </div>
        <Socials />
      </div>
